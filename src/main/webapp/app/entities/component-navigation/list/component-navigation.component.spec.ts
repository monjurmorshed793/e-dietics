...
describe('ComponentNavigation Management Component', () => {
  let comp: ComponentNavigationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ComponentNavigationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.componentNavigations?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
