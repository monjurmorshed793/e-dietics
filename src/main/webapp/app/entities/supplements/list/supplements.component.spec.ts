...
describe('Supplements Management Component', () => {
  let comp: SupplementsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SupplementsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.supplements?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
