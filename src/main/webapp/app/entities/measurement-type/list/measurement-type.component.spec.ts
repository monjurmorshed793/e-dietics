...
import { MeasurementTypeComponent } from './measurement-type.component';

describe('MeasurementType Management Component', () => {
  let comp: MeasurementTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MeasurementTypeComponent],
      providers: [
        Router,
        {
      ...
      .overrideTemplate(MeasurementTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.measurementTypes?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
