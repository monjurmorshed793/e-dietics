...
export class FoodCategoryComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.foodCategoryService
      ...
      .subscribe(
        (res: HttpResponse<IFoodCategory[]>) => {
  ...
  trackId(index: number, item: IFoodCategory): string {
    return item.id!;
  }
  ...
  protected onSuccess(data: IFoodCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
