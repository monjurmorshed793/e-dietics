...
describe('ActivityLevel Management Component', () => {
  let comp: ActivityLevelComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ActivityLevelComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.activityLevels?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
